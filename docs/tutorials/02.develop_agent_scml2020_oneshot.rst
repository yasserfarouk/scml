...
.. parsed-literal::
    ...
    Agent 01Ra@0 of type RandomOneShotAgent has a final score of 0.7502469992967512
    ...
    Agent 06Ra@1 of type RandomOneShotAgent has a final score of 0.805394818137981
    Agent 07Ra@1 of type RandomOneShotAgent has a final score of 0.6381018106371946
    Agent 08MDN@1 of type MyOneShotDoNothing has a final score of 0.48704975546325124
    Agent 09Ra@1 of type RandomOneShotAgent has a final score of 1.287237507697377
    Agent 10Ra@1 of type RandomOneShotAgent has a final score of 0.6028349465552685
    Agent 11Ra@1 of type RandomOneShotAgent has a final score of 0.8135628948718752
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.8162298295327414),
...
.. raw:: html
    ...
    <table border="1" class="dataframe">
      ...
      <tbody>
        <tr>
          <th rowspan="5" valign="top">01Ra@0</th>
          <th>06Ra@1</th>
          <td>2.800000</td>
          <td>14.300000</td>
        </tr>
...
.. parsed-literal::
    ...
    [('SimpleAgent', 1.076862555579364),
     ('RandomOneShotAgent', 0.48687279190913113)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.114329895919795), ('RandomOneShotAgent', 0.6689395329718287)]


It seems that ``BetterAgent`` is getting even **lwer** scores than
``SimpleAgent`` . Let’s dive into the agent and analyze how it works:
    ...
    class UfunTester(SimpleAgent):
        def step(self):
            ...
            for q in range(*qrange):
                ...
                quantity_value.append({"Mismatch (items)":q-needs, "Profit Difference (dollars)": diff})
...
.. code:: ipython3
    ...
    plt.title("Difference in profit between matching at worst price and mismatch at best price");
...
.. parsed-literal::
    ...
    [('AdaptiveAgent', 1.0762107477258884),
     ('RandomOneShotAgent', 0.6767407869817968)]
...
.. image:: 02.develop_agent_scml2020_oneshot_files/02.develop_agent_scml2020_oneshot_33_0.png
...
.. parsed-literal::
    ...
    [('LearningAgent', 1.0031954270409487),
     ('RandomOneShotAgent', 0.49894998988514366)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 0.8370061024181819), ('DeepSimpleAgent', 0.15127026983560932)]
...
.. image:: 02.develop_agent_scml2020_oneshot_files/02.develop_agent_scml2020_oneshot_45_0.png
...
.. parsed-literal::
    ...
    [('SyncAgent', 0.9463587133639607), ('RandomOneShotAgent', 0.5669980654613119)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.8620961479517629),
     ('SimpleSingleAgreementAgent', 0.6895517321611313)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.11922310121751455),
     ('AssumeOthersFailIndNeg', 0.06375507997358978)]
...
.. image:: 02.develop_agent_scml2020_oneshot_files/02.develop_agent_scml2020_oneshot_58_0.png


.. parsed-literal::

    [('RandomOneShotAgent', 0.17432167865781872),
     ('GreedyIndNeg', -0.44345263490132886)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.40874765734981255),
     ('GeniusIndNeg', -0.0495481422388025)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.044624499311696),
     ('SimpleAgent', 1.036659404747118),
     ('LearningAgent', 1.0205147804870642),
     ('AdaptiveAgent', 1.0147035529225326),
     ('SyncAgent', 0.9985249181990442),
     ('SimpleSingleAgreementAgent', 0.7688874265374536),
     ('GreedyIndNeg', 0.42052773560306517),
     ('GeniusIndNeg', 0.36667999114234684),
     ('DeepSimpleAgent', 0.1979185999242106)]
