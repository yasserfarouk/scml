...
.. parsed-literal::
    ...
    Agent 00MDN@0 of type MyOneShotDoNothing has a final score of 0.35647813158195824 
    Agent 01Ran@0 of type RandomOneShotAgent has a final score of 0.873950453145313 
    Agent 02MDN@0 of type MyOneShotDoNothing has a final score of 0.386739613841279 
    Agent 03MDN@0 of type MyOneShotDoNothing has a final score of -0.002241404121060149 (bankrupt)
    Agent 04MDN@1 of type MyOneShotDoNothing has a final score of 0.40034006445015474 
    Agent 05MDN@1 of type MyOneShotDoNothing has a final score of 0.6523536743024072 
    Agent 06Ran@1 of type RandomOneShotAgent has a final score of 0.7106147566440265 
    Agent 07Ran@1 of type RandomOneShotAgent has a final score of 0.5789155559308604 
    Agent 08MDN@1 of type MyOneShotDoNothing has a final score of 0.7503762231136909 
    Agent 09Ran@1 of type RandomOneShotAgent has a final score of 0.6943639584094153 
    Agent 10Ran@1 of type RandomOneShotAgent has a final score of 0.5726718797039995 
    Agent 11Ran@1 of type RandomOneShotAgent has a final score of 0.8812135236394523 
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.718621687912178),
     ('MyOneShotDoNothing', 0.4240077171947383)]
...
.. raw:: html
    ...
    <table border="1" class="dataframe">
      <thead>
        <tr>
          <th>seller_name</th>
          <th colspan="5" halign="left">01Ran@0</th>
          <th>04MDN@1</th>
          <th>05MDN@1</th>
          <th>06Ran@1</th>
          <th>07Ran@1</th>
          ...
          <th>10Ran@1</th>
          <th>11Ran@1</th>
          <th colspan="4" halign="left">SELLER</th>
        </tr>
        <tr>
          <th>buyer_name</th>
          <th>06Ran@1</th>
...
.. parsed-literal::
    ...
    [('SimpleAgent', 1.0206482848389007),
     ('RandomOneShotAgent', 0.6865702973603323)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.1795812008648343),
     ('RandomOneShotAgent', -0.15855149398299428)]
...
.. parsed-literal::
    ...
    [('AdaptiveAgent', 1.2804261245276773),
     ('RandomOneShotAgent', -0.7246189028553071)]
...
.. parsed-literal::
    ...
    [('LearningAgent', 1.2453748311862851),
     ('RandomOneShotAgent', 0.3773782100497865)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 0.7750156672988081), ('DeepSimpleAgent', -0.6115543011892781)]
...
.. parsed-literal::
    ...
    [('SyncAgent', 1.062017191327324), ('RandomOneShotAgent', -0.6522164103164491)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.8540709306574972),
     ('SimpleSingleAgreementAgent', 0.5906199113285724)]
...
.. parsed-literal::
    ...
    [('AssumeOthersFailIndNeg', 0.8009861211814175),
     ('RandomOneShotAgent', 0.6276427287059406)]


This agent simply uses its **centeral** ufun for each negotiator. This
is not a very good strategy because each negotiator is now assuming that
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', -1.3590270171555183),
     ('GreedyIndNeg', -1.973189833628935)]
...
-  All ufuns are created with ``outcome_type=tuple``. See
   ``test_ind_negotiators_genius()`` at
   ``tests/test_scml2021oneshot.py`` for an example.
-  All weights of the ``LinearUtilityAggregationFunction`` must be
   between zero and one and the weights must sum to one.
...
2. Start the negmas-genius bridbe by running on the terminal:

   .. code:: bash

      negmas genius

3. In some cases, the aforementioned command may not work correctly
...
.. parsed-literal::
    ...
    [('GeniusIndNeg', 0.35522857940253827),
     ('RandomOneShotAgent', -2.9432565391736665)]
...
.. code:: ipython3
    ...
    _, _, tscores = try_agents(
        ...
        [GeniusIndNeg] if genius_bridge_is_running() else [],
        n_trials=20,
        n_processes=2,
        draw=False
    )
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.101742494974822),
     ('LearningAgent', 1.026470489122975),
     ('AdaptiveAgent', 0.9640433798181489),
     ('SimpleAgent', 0.8481382630851352),
     ('SyncAgent', 0.841131709779224),
     ('GreedyIndNeg', 0.6929265944788605),
     ('GeniusIndNeg', 0.6444161412377085),
     ('SimpleSingleAgreementAgent', 0.5183995418169199),
     ('DeepSimpleAgent', -1.773244863042692)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 0.9840257305515868),
     ('SimpleAgent', 0.9279609742732853),
     ('LearningAgent', 0.9113145851073863),
     ('AdaptiveAgent', 0.904829988593659),
     ('SyncAgent', 0.8803712574808906),
     ('SingleAgreementAspirationAgent', 0.8108829485251743),
     ('BuyCheapSellExpensiveAgent', 0.4112348603385131),
     ('DecentralizingAgent', 0.20193277226255915),
     ('DeepSimpleAgent', 0.18708050496024892)]
