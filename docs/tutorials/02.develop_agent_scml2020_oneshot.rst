...
.. code:: ipython3
    ...
    def try_agents(agent_types, n_processes=2, n_trials=1, draw=True, agent_params=None):
        ...
        for _ in range(n_trials):
            ...
            **SCML2020OneShotWorld.generate(agent_types, agent_params=agent_params, n_steps=10, n_processes=p), 
...
.. parsed-literal::
    ...
    Agent 00Ran@0 of type RandomOneShotAgent has a final score of 1.0079317429836847 
    Agent 01MDN@0 of type MyOneShotDoNothing has a final score of 0.5856197729814842 
    Agent 02MDN@0 of type MyOneShotDoNothing has a final score of 0.48093791546372755 
    Agent 03Ran@1 of type RandomOneShotAgent has a final score of 0.8624088801846588 
    Agent 04Ran@1 of type RandomOneShotAgent has a final score of 0.8328274979567087 
    Agent 05MDN@1 of type MyOneShotDoNothing has a final score of 0.6800519966946793 
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.9010560403750173), ('MyOneShotDoNothing', 0.5822032283799636)]
...
.. parsed-literal::
    ...
    [('GreedyOneShotAgent', 0.8614658011135294), ('RandomOneShotAgent', 0.7170864832205055)]
...
One problem with our ``GreedyOneShotAgent`` is that it does not take
price into account in two ways:
...
.. code:: ipython3
    ...
    class BetterGreedyAgent(GreedyOneShotAgent):
    ...
    world, ascores, tscores = try_agent(BetterGreedyAgent)
...
.. parsed-literal::
    ...
    [('BetterGreedyAgent', 1.2292203272783455), ('RandomOneShotAgent', -0.47076647551927664)]


It seems that ``BetterGreedyAgent`` is getting higher scores than
``GreedyOneShotAgent`` as expected. Let’s dive into the agent and
analyze how it works:

The main idea in ``BetterGreedyAgent`` is to treat the *price* issue
...
.. code:: ipython3
    ...
    for e in [0.1, 0.2, 1.0, 5, 10]:
        a = BetterGreedyAgent(concession_exponent=e)
...
the behavior of the ``GreedyOneShotAgent`` in offering but will make it
...
:math:`\inf` will recover the behavior of ``GreedyOneShotAgent`` in
responding to offers but will make its offers least favorable for itself
in terms of price (can you see why?)
...
.. code:: ipython3
    ...
    class AdaptiveGreedyAgent(BetterGreedyAgent):
    ...
    world, ascores, tscores = try_agent(AdaptiveGreedyAgent)
...
.. parsed-literal::
    ...
    [('AdaptiveGreedyAgent', 1.2006214283616197), ('RandomOneShotAgent', 0.06261871855752332)]
...
.. code:: ipython3
    ...
    class LearningGreedyAgent(AdaptiveGreedyAgent):
        def __init__(
            self,
            *args,
    ...
    world, ascores, tscores = try_agent(LearningGreedyAgent)
...
.. parsed-literal::
    ...
    [('LearningGreedyAgent', 1.4040493819013087), ('RandomOneShotAgent', 0.7958093059983768)]
...
in the same way ``AdaptiveGreedyAgent`` did in ``init()`` and
``step()``.
...
.. code:: ipython3
    ...
    world, ascores, tscores = try_agents([BetterGreedyAgent, DeepGreedyAgent], n_processes=3)



.. image:: 02.develop_agent_scml2020_oneshot_files/02.develop_agent_scml2020_oneshot_35_0.png
...
``GreedyOneShot`` agent on the other hand cannot do so.
...
.. parsed-literal::
    ...
    [('BetterGreedyAgent', 0.8520866342970472), ('DeepGreedyAgent', 0.3637648953603516)]
...
.. code:: ipython3
    ...
    class GreedySyncAgent(OneShotSyncAgent, BetterGreedyAgent):
...
.. image:: 02.develop_agent_scml2020_oneshot_files/02.develop_agent_scml2020_oneshot_44_0.png
...
.. parsed-literal::
    ...
    [('GreedySyncAgent', 0.9013442415312164), ('RandomOneShotAgent', 0.6496846910005512)]
...
.. image:: 02.develop_agent_scml2020_oneshot_files/02.develop_agent_scml2020_oneshot_49_0.png
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.869469629333418), ('GreedySingleAgreementAgent', 0.2876309454313417)]
...
.. parsed-literal::
    ...
    [('GreedySyncAgent', 0.9544933872871035), ('GreedyOneShotAgent', 0.8577331084713194), ('GreedySingleAgreementAgent', 0.6238889124800848)]
...
.. code:: ipython3
    ...
    _, _, tscores = try_agents(
    [DeepGreedyAgent, BetterGreedyAgent, LearningGreedyAgent, AdaptiveGreedyAgent, GreedySyncAgent, SingleAgreementAspirationAgent, BuyCheapSellExpensiveAgent, DecentralizingAgent],
    n_processes = 4,
    n_trials = 10,
    draw = False,
    )
...
.. parsed-literal::
    ...
    [('LearningGreedyAgent', 0.9419733640092363), ('AdaptiveGreedyAgent', 0.8917391255536419), ('GreedySyncAgent', 0.860911841510035), ('BetterGreedyAgent', 0.8470075297765208), ('SingleAgreementAspirationAgent', 0.736091755913266), ('DeepGreedyAgent', 0.5479954383578245), ('DecentralizingAgent', 0.5128701548996241), ('BuyCheapSellExpensiveAgent', 0.48424398371160926)]
