...
.. parsed-literal::
    ...
    Agent 00MDN@0 of type MyOneShotDoNothing has a final score of 0.6944068952119954
    Agent 01Ran@0 of type RandomOneShotAgent has a final score of 1.1091968037702151
    Agent 02MDN@0 of type MyOneShotDoNothing has a final score of 0.7450624606556975
    Agent 03MDN@0 of type MyOneShotDoNothing has a final score of 0.6773363560839638
    Agent 04MDN@1 of type MyOneShotDoNothing has a final score of 0.889931458499155
    Agent 05MDN@1 of type MyOneShotDoNothing has a final score of 0.9485817404064244
    Agent 06Ran@1 of type RandomOneShotAgent has a final score of 0.8786735485451
    Agent 07Ran@1 of type RandomOneShotAgent has a final score of 0.8751916425602381
    Agent 08MDN@1 of type MyOneShotDoNothing has a final score of 0.7353892618009944
    Agent 09Ran@1 of type RandomOneShotAgent has a final score of 0.9469486266281616
    Agent 10Ran@1 of type RandomOneShotAgent has a final score of 0.8795194773733399
    Agent 11Ran@1 of type RandomOneShotAgent has a final score of 0.9136405327126119
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.933861771931611),
     ('MyOneShotDoNothing', 0.7817846954430384)]
...
.. parsed-literal::
    ...
    [('SimpleAgent', 1.0308766983693725),
     ('RandomOneShotAgent', 0.7927155490572136)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.2761764123441648),
     ('RandomOneShotAgent', 0.6284724432137471)]
...
.. parsed-literal::
    ...
    [('AdaptiveAgent', 1.2283830915551999),
     ('RandomOneShotAgent', 0.7972927313602288)]
...
.. parsed-literal::
    ...
    [('LearningAgent', 1.427505886007057),
     ('RandomOneShotAgent', 0.3398072268880339)]
...
.. code:: python
   ...
   def _needed(self, negotiator_id):
       summary = self.awi.exogenous_contract_summary
       secured = (
           self._sales if self._is_selling(self.get_ami(negotiator_id)) else self._supplies
       )
       demand = min(summary[0][0], summary[-1][0]) / (self.awi.n_competitors + 1)
       return demand - secured
...
.. parsed-literal::
    ...
    [('BetterAgent', 0.87050371128801), ('DeepSimpleAgent', 0.048137641879403344)]
...
.. parsed-literal::
    ...
    [('SyncAgent', 1.227755945465853), ('RandomOneShotAgent', 0.6201527597868522)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.7725987240289136),
     ('SimpleSingleAgreementAgent', 0.7260478711700908)]
...
.. parsed-literal::
    ...
    [('AssumeOthersFailIndNeg', 0.6289458478430019),
     ('RandomOneShotAgent', -0.2353792294057782)]
...
.. parsed-literal::
    ...
    [('GreedyIndNeg', 0.26037883791377564),
     ('RandomOneShotAgent', -0.43923773514376424)]
...
.. parsed-literal::
    ...
    [('GeniusIndNeg', 1.3080147154491244),
     ('RandomOneShotAgent', -1.245572223240841)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.1303452406365202),
     ('AdaptiveAgent', 1.1278314745695721),
     ('LearningAgent', 1.065261019845276),
     ('SyncAgent', 1.0206501914927832),
     ('GreedyIndNeg', 0.9977847890605633),
     ('GeniusIndNeg', 0.9554417399867485),
     ('SimpleAgent', 0.8957310032715197),
     ('SimpleSingleAgreementAgent', 0.746431076432043),
     ('DeepSimpleAgent', -0.6209489320843363)]
...
.. parsed-literal::
    ...
    [('LearningAgent', 0.97215424824692),
     ('SingleAgreementAspirationAgent', 0.9198272603438871),
     ('BetterAgent', 0.9125352540929835),
     ('SimpleAgent', 0.9121195859476694),
     ('AdaptiveAgent', 0.9095059936465888),
     ('SyncAgent', 0.8876533614385824),
     ('DeepSimpleAgent', 0.691818236763754),
     ('DecentralizingAgent', 0.5869468760300468),
     ('BuyCheapSellExpensiveAgent', 0.3293259902238389)]
