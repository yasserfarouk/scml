...
.. parsed-literal::
    ...
    Agent 01Ran@0 of type RandomOneShotAgent has a final score of 0.986641975972104
    ...
    Agent 06Ran@1 of type RandomOneShotAgent has a final score of 0.7143879750376534
    Agent 07Ran@1 of type RandomOneShotAgent has a final score of 0.8323896859544185
    Agent 08MDN@1 of type MyOneShotDoNothing has a final score of 0.48704975546325124
    Agent 09Ran@1 of type RandomOneShotAgent has a final score of 0.8786014074593169
    Agent 10Ran@1 of type RandomOneShotAgent has a final score of 0.8276963097529048
    Agent 11Ran@1 of type RandomOneShotAgent has a final score of 0.8129031884717791
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.842103423774696),
...
.. parsed-literal::
    ...
    [('SimpleAgent', 1.0618490425022955), ('RandomOneShotAgent', 0.779155817275618)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 0.9285759579447519),
     ('RandomOneShotAgent', 0.5560642374450893)]
...
.. parsed-literal::
    ...
    [('AdaptiveAgent', 1.573309689260109),
     ('RandomOneShotAgent', 0.31531037520482535)]
...
.. parsed-literal::
    ...
    [('LearningAgent', 1.7658792975735875),
     ('RandomOneShotAgent', -0.13521083800317218)]
...
.. parsed-literal::
    ...
    [('BetterAgent', 1.0629370580165551), ('DeepSimpleAgent', -0.10452587813433352)]
...
.. parsed-literal::
    ...
    [('SyncAgent', 1.118821407026792), ('RandomOneShotAgent', 0.8024416020898135)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.8662845582516588),
     ('SimpleSingleAgreementAgent', 0.7669599207057102)]
...
.. parsed-literal::
    ...
    [('AssumeOthersFailIndNeg', 0.34763409665435563),
     ('RandomOneShotAgent', -0.12546060103598855)]
...
.. parsed-literal::
    ...
    [('GreedyIndNeg', 0.35376615806100403),
     ('RandomOneShotAgent', -0.007792102081922242)]
...
-  In some cases, the aforementioned command may not work correctly
   ...
   ``bash  java -jar ~/nemga/files/geniusbridge.jar``
...
.. parsed-literal::
    ...
    [('GeniusIndNeg', 0.9172427805270843),
     ('RandomOneShotAgent', -0.018133541328785974)]
...
.. parsed-literal::
    ...
    [('LearningAgent', 1.2288677080700625),
     ('AdaptiveAgent', 1.1431130690447189),
     ('BetterAgent', 1.0914302132024296),
     ('GeniusIndNeg', 1.0441383365834571),
     ('SyncAgent', 0.9523479290212987),
     ('SimpleAgent', 0.9429384494467841),
     ('SimpleSingleAgreementAgent', 0.8001324461048595),
     ('GreedyIndNeg', 0.5245262940513329),
     ('DeepSimpleAgent', -0.05917603579247174)]
...
.. parsed-literal::
    ...
    [('SimpleAgent', 0.9544178234639343),
     ('SingleAgreementAspirationAgent', 0.953908348272002),
     ('LearningAgent', 0.9511419076855497),
     ('AdaptiveAgent', 0.935086620326453),
     ('BetterAgent', 0.9272982807347759),
     ('SyncAgent', 0.9113784443846548),
     ('DecentralizingAgent', 0.8242395591838448),
     ('BuyCheapSellExpensiveAgent', 0.6955505738047882),
     ('DeepSimpleAgent', 0.622779532203584)]
...
2. The agent will not be able to do any trade about any steps beyond the
   next step. 1112wqesdfcgvhjkl;’]
   :raw-latex:`\uYH` With that we end our tutorial. Have fun developing
   your agent.
