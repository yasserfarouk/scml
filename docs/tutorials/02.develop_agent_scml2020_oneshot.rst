...
.. code:: ipython3
    ...
    class SyncRandomAgent(OneShotSyncAgent):
        ...
        def __init__(self, *args, threshold=0, timelimit=0.85, **kwargs):
            super().__init__(*args, **kwargs)
            self._threshold, self._timelimit = threshold, timelimit
        ...
        def counter_all(self, offers, states):
            ...
            # other negotiations
            if states:
                relative_time = max(s.relative_time for s in states.values())
            else:
                relative_time = 0.0
            if best_diff <= self._threshold or relative_time >= self._timelimit:
...
.. parsed-literal::
    ...
    [('SyncRandomAgent', 1.0851458183785867),
     ('RandomOneShotAgent', 0.42928080054982604)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.722522024093111),
     ('SimpleSingleAgreementAgent', 0.7200691935492209)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.2566272118427171),
     ('AssumeOthersFailIndNeg', 0.085204738797534)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', -0.010883393027604426),
     ('GreedyIndNeg', -0.016054870717640866)]
...
.. parsed-literal::
    ...
    [('RandomOneShotAgent', 0.16321734463231483),
     ('GeniusIndNeg', 0.01949078462532807)]
...
.. parsed-literal::
    ...
    [('SyncRandomAgent', 0.8776705380093004),
     ('DeepSimpleAgent', 0.5753166391841517)]
...
.. parsed-literal::
    ...
    [('SimpleAgent', 1.0653484907200392),
     ('SyncRandomAgent', 1.0178931059063354),
     ('BetterAgent', 1.0080199931169058),
     ('NaiveSyncAgent', 0.9788922028735115),
     ('AdaptiveAgent', 0.9569234268624955),
     ('LearningAgent', 0.9475927112517355),
     ('SimpleSingleAgreementAgent', 0.7523796112761708),
     ('GreedyIndNeg', 0.627085822700412),
     ('GeniusIndNeg', 0.41842480612224797),
     ('DeepSimpleAgent', 0.2654059947491325)]
