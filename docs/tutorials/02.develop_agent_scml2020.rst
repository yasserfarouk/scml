...
2. **Negotiation Control Strategy**: This component is responsible for
   ...
   and actually conducting concurrent negotaitions.
...
overrided in your agent class to allow all components to run.** For a
clear explanation of hte use of ``super`` refer to `Hettinger’s
...
.. image:: 02.develop_agent_scml2020_files/02.develop_agent_scml2020_18_0.png
...
.. code:: ipython3
    ...
    class MyAgent(PredictionBasedTradingStrategy, DemandDrivenProductionStrategy, DoNothingAgent):
        """My agent"""
...
.. image:: 02.develop_agent_scml2020_files/02.develop_agent_scml2020_21_0.png
...
.. code:: ipython3
    ...
    class MyAgent(IndependentNegotiationsManager, PredictionBasedTradingStrategy, DemandDrivenProductionStrategy, DoNothingAgent):
        pass
...
.. image:: 02.develop_agent_scml2020_files/02.develop_agent_scml2020_27_0.png
...
.. image:: 02.develop_agent_scml2020_files/02.develop_agent_scml2020_29_0.png
...
.. image:: 02.develop_agent_scml2020_files/02.develop_agent_scml2020_40_0.png
