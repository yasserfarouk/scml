...
.. parsed-literal::
    ...
    (<AxesSubplot:title={'center':'Step: 10/10 [ 0s rem  0s] 100.00%'}>,
     <networkx.classes.multidigraph.MultiDiGraph at 0x17f7d14b0>)
...
.. parsed-literal::
    ...
    [["Contract(agreement={'time': 1, 'quantity': 10, 'unit_price': 5}, "
      ...
      "id='c0b45236-a804-4d1a-8616-35b1156fe9b5')"],
