...
.. parsed-literal::
    ...
    (<AxesSubplot:title={'center':'Step: 11/10 [12s rem -1s] 110.00%'}>,
     <networkx.classes.multidigraph.MultiDiGraph at 0x125bf3250>)
