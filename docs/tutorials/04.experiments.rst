...
.. parsed-literal::
    ...
    (<AxesSubplot:title={'center':'Step: 10/10 [ 0s rem  0s] 100.00%'}>,
     <networkx.classes.multidigraph.MultiDiGraph at 0x28a4a64a0>)
...
.. parsed-literal::
    ...
    [["Contract(agreement={'time': 1, 'quantity': 10, 'unit_price': 5}, "
      ...
      "id='eb5929a6-6cb5-47ee-b82c-a8b1f2a55181')"],
