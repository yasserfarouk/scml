...
.. parsed-literal::
    ...
    (<AxesSubplot:title={'center':'Step: 11/10 [ 2s rem  0s] 110.00%'}>,
     <networkx.classes.multidigraph.MultiDiGraph at 0x11ee16130>)
