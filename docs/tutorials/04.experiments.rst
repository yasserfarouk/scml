...
.. parsed-literal::
    ...
    (<AxesSubplot:title={'center':'Step: 11/10 [ 4s rem  0s] 110.00%'}>,
     <networkx.classes.multidigraph.MultiDiGraph at 0x11c54ef10>)
