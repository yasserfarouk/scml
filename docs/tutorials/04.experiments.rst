...
.. parsed-literal::
    ...
    (<AxesSubplot:title={'center':'Step: 11/10 [ 3s rem  0s] 110.00%'}>,
     <networkx.classes.multidigraph.MultiDiGraph at 0x125e90b50>)
