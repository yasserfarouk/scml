...
Given that storage cost is zero and storage capacity is infinite, it
...
production cost, storage cost, and delivery cost). This means that you
...
Download :download:`Notebook<notebooks/05.ideas.ipynb>`.
