...
from scml.std.agents import GreedyStdAgent
from scml.std.rl.common import WorldFactory
from scml.std.rl.factory import ANACStdFactory
...
class StdRLAgent(StdPolicy):
    """A std agent that can execute a trained RL policy in appropriate worlds. It falls back to the given agent type otherwise"""
    ...
    def __init__(
        ...
        *args,
        ...
        fallback_type: type[StdAgent] = GreedyStdAgent,
        ...
        **kwargs,
        ...
        if action_managers is None:
            action_managers = [
                UnconstrainedActionManager(ANACStdFactory())
        ...
        self._fallback_agent: StdAget = None  # type: ignore
