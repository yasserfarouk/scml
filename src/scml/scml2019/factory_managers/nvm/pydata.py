...
def save_json_uncertainty_model(json_file_name: str, raw_uncertainty_model: pd.DataFrame, products: list):
    """
    ...
    :return:
    """
    d = {product: {t: get_prob_dist(raw_uncertainty_model, t, product) for t in range(1, 100)} for product in products}
