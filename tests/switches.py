...
SCML_RUN_STD_TOURNAMENTS = os.environ.get(
    "SCML_RUN_STD_TOURNAMENTS", not SCML_RUN_TOURNAMENTS or SCML_RUNALL_TESTS
)
SCML_RUN_COLLUSION_TOURNAMENTS = os.environ.get(
    "SCML_RUN_COLLUSION_TOURNAMENTS", not SCML_RUN_TOURNAMENTS or SCML_RUNALL_TESTS
)
SCML_RUN_SABOTAGE_TOURNAMENTS = os.environ.get(
    "SCML_RUN_SABOTAGE_TOURNAMENTS", not SCML_RUN_TOURNAMENTS or SCML_RUNALL_TESTS
)
